...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func customizeAppearance() {
        UINavigationBar.appearance().titleTextAttributes = [NSFontAttributeName: UIFont.SFMedium(17.0)!, NSForegroundColorAttributeName: UIColor.whiteColor()]
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "vanfordinc.Tweed" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Tweed", withExtension: "momd")!
